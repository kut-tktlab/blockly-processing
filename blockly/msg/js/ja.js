...
Blockly.Msg.COLOUR_ALPHA_TITLE = "半透明にする 色 %1 不透明度 %2";
Blockly.Msg.COLOUR_ALPHA_TOOLTIP = "不透明度を指定して半透明色を作成します。不透明度は 0 ～ 100 の間でなければなりません。";
...
Blockly.Msg.COLOUR_GRAY_TITLE = "無彩色 ";
Blockly.Msg.COLOUR_GRAY_TOOLTIP = "明度の量を指定して無彩色を作成します。明度は 0 ～ 100 の間でなければなりません。";
Blockly.Msg.COLOUR_HSV_HUE = "色相";
Blockly.Msg.COLOUR_HSV_SATURATION = "彩度";
Blockly.Msg.COLOUR_HSV_TOOLTIP = "色相、彩度、明度の量を指定して色を作成します。色相は 0 〜 360 の間、彩度と明度は 0 ～ 100 の間でなければなりません。";
Blockly.Msg.COLOUR_HSV_VALUE = "明度";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP = "赤、緑、青の量を指定して色を作成します。すべての値は 0 ～ 100 の間でなければなりません。";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https://github.com/google/blockly/wiki/Loops#loop-termination-blocks";  // untranslated
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "ループから抜け出す";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "ループの次の反復処理に進む";
...
Blockly.Msg.CONTROLS_FOR_SIMPLE_TITLE = "変数%1を 0 〜 %2 に変えて繰り返す";
Blockly.Msg.CONTROLS_FOR_SIMPLE_TOOLTIP = "変数 '%1' の値を0から終了値まで1ずつ変えながら、ステートメントを実行する。";
Blockly.Msg.CONTROLS_FOR_TITLE = "変数%1を %2 から %3 まで %4 ずつ変えて繰り返す";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "変数 '%1' の値を開始値から終了値まで指定の間隔で変えながら、ステートメントを実行する。";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "「もし」のブロックに条件を追加します。";
...
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "ちがえば";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "そうでなくてもし";
Blockly.Msg.CONTROLS_IF_MSG_IF = "もし";
Blockly.Msg.CONTROLS_IF_MSG_THEN = "なら";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "値が真の場合、ステートメントを実行します。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "値が真の場合は、最初のブロックを実行します。それ以外の場合は、2番目のブロックを実行します。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "最初の値が真の場合は、最初のブロックを実行します。それ以外の場合は、2 番目の値が真の場合、2番目のブロックを実行します。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "最初の値が真の場合は、最初のブロックを実行します。そうでなくて2番目の値が真の場合は、2番目のブロックを実行します。それ以外の場合は最後のブロックを実行します。";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "値が偽の間、ステートメントを実行する。";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "値が真の間、ステートメントを実行する。";
Blockly.Msg.CONTROLS_WHILE_TITLE = "%1 である間繰り返す";
...
Blockly.Msg.FIGURES_ARC = "扇形";
Blockly.Msg.FIGURES_BACKGROUND_TITLE = "画面を消す 色 %1";
Blockly.Msg.FIGURES_COLOUR_TITLE = "%1 の色 %2";
Blockly.Msg.FIGURES_ELLIPSE = "楕円";
Blockly.Msg.FIGURES_FILL = "塗りつぶし";
Blockly.Msg.FIGURES_LINE = "線分";
Blockly.Msg.FIGURES_NOFILL_TITLE = "%1 を描かない";
Blockly.Msg.FIGURES_POINT = "点";
Blockly.Msg.FIGURES_QUAD = "四辺形";
Blockly.Msg.FIGURES_RECT = "長方形";
Blockly.Msg.FIGURES_SHAPE_END_ANGLE = "終了角";
Blockly.Msg.FIGURES_SHAPE_HEIGHT = "高さ";
Blockly.Msg.FIGURES_SHAPE_START_ANGLE = "開始角";
Blockly.Msg.FIGURES_SHAPE_TITLE = "%1 を描く x %2 y %3 幅 %4 高さ %5";
...
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "以下の要素からなる新しい配列";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "リストに項目を追加。";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "指定した要素からなる配列を作成します。要素数は自由に変更できます。";
...
Blockly.Msg.LISTS_GET_INDEX_SIMPLE_TITLE = "配列 %1 の第 %2 要素";
Blockly.Msg.LISTS_GET_INDEX_TAIL = "";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "リストの最初の項目を返します。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM = "配列の指定位置の要素を返します。";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP = "リストが空の場合は、真を返します。";
Blockly.Msg.LISTS_LENGTH_HELPURL = "https://github.com/google/blockly/wiki/Lists#length-of";  // untranslated
Blockly.Msg.LISTS_LENGTH_TITLE = "%1の長さ";
Blockly.Msg.LISTS_LENGTH_TOOLTIP = "配列の長さを返します。";
Blockly.Msg.LISTS_REPEAT_HELPURL = "https://github.com/google/blockly/wiki/Lists#create-list-with";  // untranslated
Blockly.Msg.LISTS_REPEAT_SIMPLE_TITLE = "%1要素の新しい配列";
Blockly.Msg.LISTS_REPEAT_SIMPLE_TOOLTIP = "指定された要素数の配列を作成します。";
...
Blockly.Msg.LISTS_SET_INDEX_SIMPLE_TITLE = "配列 %1 の第 %2 要素を %3 にする";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM = "配列の指定された要素の値を設定します。";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "両辺が等しい場合に真を返します。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT = "最初の入力が2番目の入力よりも大きい場合に真を返します。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE = "最初の入力が2番目の入力よりも大きいか同じである場合に真を返します。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT = "最初の入力が2番目の入力よりも小さい場合に真を返します。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "最初の入力が2番目の入力より小さいか同じである場合に真を返します。";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "両辺が等しくない場合に真を返します。";
Blockly.Msg.LOGIC_NEGATE_HELPURL = "https://ja.wikipedia.org/wiki/否定";
Blockly.Msg.LOGIC_NEGATE_TITLE = "%1ではない";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP = "入力が偽の場合は真を返します。入力が真の場合は 偽を返します。";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "両方の入力が真のときに真を返します。";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "少なくとも1つの入力が真のときに真を返します。";
Blockly.Msg.LOGIC_TERNARY_CONDITION = "テスト";
Blockly.Msg.LOGIC_TERNARY_HELPURL = "https://ja.wikipedia.org/wiki/%3F:";
Blockly.Msg.LOGIC_TERNARY_IF_FALSE = "偽の場合";
Blockly.Msg.LOGIC_TERNARY_IF_TRUE = "真の場合";
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "'テスト' の条件をチェックします。条件が真の場合、'true' の値を返します。それ以外の場合 'false' の値を返します。";
...
Blockly.Msg.MATH_CHANGE_TITLE = "%1 を %2 だけ増やす";
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = "%1を%2〜%3に制限";
...
Blockly.Msg.MATH_RANDOM_INT_TITLE = "0 〜 %1 の乱数";
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "指定された（上下限を含む）範囲のランダムな整数を返します。";
Blockly.Msg.MATH_RANDOM_TITLE = "%1 以上 %2 未満の乱数";
Blockly.Msg.MATH_RANDOM_TOOLTIP = "指定された範囲 (下限は含み上限は含まない) の乱数を返します。";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "自然対数の底eの累乗を返す。";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10 = "10の累乗を返す。";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_ATAN2 = "Y座標・X座標の組に対するアークタンジェント（arctan）を返す。";
...
Blockly.Msg.PROCEDURES_IFRETURN_RETURN = "なら返す";
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "1番目の値が真の場合、2番目の値を返します。";
...
Blockly.Msg.RENAME_VARIABLE_TITLE = "すべての変数 %1 の名前を変える：";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP = "与えられたテキストが空の場合は真を返す。";
Blockly.Msg.TEXT_JOIN_HELPURL = "https://github.com/google/blockly/wiki/Text#text-creation";  // untranslated
Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH = "連接";
Blockly.Msg.TEXT_JOIN_TOOLTIP = "任意個の項目を連接した1個のテキストを作ります。";
Blockly.Msg.TEXT_LENGTH_HELPURL = "https://github.com/google/blockly/wiki/Text#text-modification";  // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "%1の長さ";
Blockly.Msg.TEXT_LENGTH_TOOLTIP = "与えられたテキストの (空白を含む) 文字数を返します。";
Blockly.Msg.TEXT_PRINT_HELPURL = "https://github.com/google/blockly/wiki/Text#printing-text";  // untranslated
Blockly.Msg.TEXT_PRINT_TITLE = "コンソールに出力 %1";
Blockly.Msg.TEXT_PRINT_TOOLTIP = "指定したテキストや数値やその他の値を出力します。";
...
Blockly.Msg.TEXT_TEXT_TOOLTIP = "文字や単語からなるテキスト。";
...
Blockly.Msg.VARIABLES_GET_CREATE_SET = "' %1 の値を…にする' を作成します。";
Blockly.Msg.VARIABLES_GET_HELPURL = "https://github.com/google/blockly/wiki/Variables#get";  // untranslated
Blockly.Msg.VARIABLES_GET_TOOLTIP = "この変数の値を返します。";
Blockly.Msg.VARIABLES_SET = "%1 の値を %2 にする";
Blockly.Msg.VARIABLES_SET_CREATE_GET = "'%1 を取得' を作成します。";
Blockly.Msg.VARIABLES_SET_HELPURL = "https://github.com/google/blockly/wiki/Variables#set";  // untranslated
Blockly.Msg.VARIABLES_SET_TOOLTIP = "変数の値を設定します。";
